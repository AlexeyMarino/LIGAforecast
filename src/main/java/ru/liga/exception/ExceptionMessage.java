...
public class ExceptionMessage {
    ...
    public static final String ILLEGAL_ALGORITHM = "Необхадимо выбрать алгоритм предсказания, воспользуйтесь командой 'help'";
    ...
    public static final String ILLEGAL_CURRENCY = "Название вылюты указано в неправильном формате";
